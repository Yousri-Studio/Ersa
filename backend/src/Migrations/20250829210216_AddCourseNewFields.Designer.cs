...
namespace ErsaTraining.API.Migrations
{
    ...
    [Migration("20250829210216_AddCourseNewFields")]
    partial class AddCourseNewFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ErsaTraining.API.Data.Entities.ContentPage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a62ff65d-0199-4877-8850-e5fc49b7e81f"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8064),
                            Description = "Main landing page of the website",
                            IsActive = true,
                            PageKey = "home",
                            PageName = "Home Page",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8310)
                        },
                        new
                        {
                            Id = new Guid("5b4cfeab-b89f-458c-a00b-da5f8e10161b"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8545),
                            Description = "Company information and mission",
                            IsActive = true,
                            PageKey = "about",
                            PageName = "About Us",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8546)
                        },
                        new
                        {
                            Id = new Guid("217b867a-6300-4a48-9203-c3402d111430"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8549),
                            Description = "Contact information and form",
                            IsActive = true,
                            PageKey = "contact",
                            PageName = "Contact Us",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8549)
                        },
                        new
                        {
                            Id = new Guid("e5baf98f-924b-44dc-871b-9968d1c529af"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8565),
                            Description = "Frequently asked questions",
                            IsActive = true,
                            PageKey = "faq",
                            PageName = "FAQ",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8566)
                        },
                        new
                        {
                            Id = new Guid("3fe25ac6-7d19-4b2c-aa38-1c53044afe51"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8568),
                            Description = "Our services overview",
                            IsActive = true,
                            PageKey = "services",
                            PageName = "Services",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8569)
                        },
                        new
                        {
                            Id = new Guid("0fe8df77-3ec2-4511-a9c1-2a8e850ac061"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8571),
                            Description = "Available training courses",
                            IsActive = true,
                            PageKey = "courses",
                            PageName = "Courses",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8572)
                        },
                        new
                        {
                            Id = new Guid("4af1fca1-ec21-4e73-ba4b-8017a39fb181"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8574),
                            Description = "Artificial Intelligence services",
                            IsActive = true,
                            PageKey = "ai-solutions",
                            PageName = "AI Solutions",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8575)
                        },
                        new
                        {
                            Id = new Guid("1e15ad9d-a1e9-47c8-963c-542e4a10fb06"),
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8577),
                            Description = "Administrative consulting services",
                            IsActive = true,
                            PageKey = "admin-consulting",
                            PageName = "Administrative Consulting",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 549, DateTimeKind.Utc).AddTicks(8578)
                        });
                });
            ...
            modelBuilder.Entity("ErsaTraining.API.Data.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ae9c1fac-52e0-4f51-8f65-fd7ff062def3"),
                            ...
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 548, DateTimeKind.Utc).AddTicks(8596),
                            Key = "Welcome",
                            SubjectAr = "مرحباً بك في إرساء للتدريب",
                            SubjectEn = "Welcome to Ersa Training",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 548, DateTimeKind.Utc).AddTicks(9009)
                        },
                        new
                        {
                            Id = new Guid("e2ed7c6a-ee45-46bb-991e-eff9b226a3e1"),
                            ...
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 548, DateTimeKind.Utc).AddTicks(9246),
                            Key = "LiveDetails",
                            SubjectAr = "تفاصيل الدورة المباشرة - {{CourseTitleAr}}",
                            SubjectEn = "Live Course Details - {{CourseTitleEn}}",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 548, DateTimeKind.Utc).AddTicks(9246)
                        },
                        new
                        {
                            Id = new Guid("751a999a-7882-4fef-a16e-aa4be9d02344"),
                            ...
                            CreatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 548, DateTimeKind.Utc).AddTicks(9250),
                            Key = "MaterialsDelivery",
                            SubjectAr = "مواد الدورة - {{CourseTitleAr}}",
                            SubjectEn = "Course Materials - {{CourseTitleEn}}",
                            UpdatedAt = new DateTime(2025, 8, 29, 21, 2, 14, 548, DateTimeKind.Utc).AddTicks(9250)
                        });
                });
